...
static const int async_read_expire = 3000;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 3000;	/* ditto for write async, these limits are SOFT! */
